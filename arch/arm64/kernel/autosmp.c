...
#define define_one_global_ros(_name)                 \
static struct global_attr _name =                   \
__ATTR(_name, 0444, show_##_name, NULL)

#define define_one_global_rws(_name)                 \
static struct global_attr _name =                   \
...
define_one_global_rws(file_name);
...
define_one_global_rws(min_cpus_lc);
define_one_global_rws(min_cpus_bc);
define_one_global_rws(max_cpus_lc);
define_one_global_rws(max_cpus_bc);
